<template>
    <div class="list">
        <div class="titleBox relative">新增修改销量任务
        ...
        <div class="p20">
            <el-form ref="form"
                ...
                <el-row :gutter="20">
                    ...
                    <el-col class="clear"
                        :span="8">
                        <el-form-item label="我的店铺"
                            prop="sid">
                            <el-select v-model="form.sid"
                                placeholder="请选择">
                                <el-option v-for="(item,index) in shopBox"
                                    :key="index"
                                    :label="item.name"
                    ...
                    <el-col class="clear"
                        ...
                        <el-form-item label="商品链接"
                            prop="product_url">
                            <el-input v-model="form.product_url"
                                placeholder="商品链接"></el-input>
                        </el-form-item>
                    </el-col>
                    <el-col class="clear"
                        :span="5">
                        <el-form-item label="商品搜索价"
                            prop="product_search_price">
                            <el-input type="number"
                                style="min-width:100px"
                                v-model="form.product_search_price"
                                placeholder="搜索价"></el-input>
                        </el-form-item>
                    </el-col>
                    <el-col :span="5">
                        <el-form-item label="商品成交价"
                            prop="product_buy_price">
                            <el-input style="min-width:100px"
                                type="number"
                                v-model="form.product_buy_price"
                                placeholder="成交价"></el-input>
                        </el-form-item>
                    </el-col>
                    ...
                    <el-col class="clear"
                        ...
                        <el-form-item label="付款人数约"
                            ...
                            <el-input type="number"
                                ...
                                placeholder="付款人数约"></el-input>
                        </el-form-item>
                    </el-col>
                    <el-col :span="8">
                        <el-form-item label="商品所在地"
                            prop="product_address">
                            <el-input v-model="form.product_address"
                                placeholder="商品所在地"></el-input>
                        </el-form-item>
                    </el-col>
                    <el-col :span="8">
                        <el-form-item label="购买规格"
                            prop="product_format">
                            <el-input v-model="form.product_format"
                                placeholder="购买规格"></el-input>
                        </el-form-item>
                    </el-col>
                    <el-col class="clear"
                        :span="8">
                    ...
                    <el-col class
                        :span="2">
                        <el-form-item prop="end_price"
                            label-width="0">
                            <el-input style="min-width:100px"
                                type="number"
                                v-model="form.end_price"
                                placeholder="结束价格"></el-input>
                        </el-form-item>
                    </el-col>
                    <el-col class
                        :span="8">
                    ...
                    <div class="Additional"
                        v-for="(item,index) in form.attgoods"
                        :key="index">
                        <el-button type="danger"
                            class="delItem"
                            icon="el-icon-delete"
                            circle
                            @click="delItem(index)"></el-button>
                        <el-row :gutter="20"
                            style="padding:0 100px 0 240px">
                            <el-col :span="6"
                                class="AdditionalPic">
                                <el-form-item label="商品主图"
                            ...
                            <el-col class="clear"
                                :span="8">
                                <el-form-item label="商品成交价"
                                    :prop="'attgoods.' + index + '.product_buy_price'"
                                    :rules="{
										required: true, message: '不能为空!', trigger: 'blur'
									}">
                                    <el-input type="text"
                                        v-model="item.product_buy_price"
                                        placeholder="商品成交价"></el-input>
                                </el-form-item>
                            </el-col>
                            <el-col :span="8">
                                <el-form-item label="下单商品数量"
                                    :prop="'attgoods.' + index + '.product_buy_num'"
                                    :rules="{
										required: true, message: '不能为空!', trigger: 'blur'
									}">
                                    <el-input type="text"
                                        v-model="item.product_buy_num"
                                        placeholder="下单商品数量"></el-input>
                                </el-form-item>
                            </el-col>
                            <el-col :span="8">
                                <el-form-item label="购买规格">
                        ...
                        <el-row :gutter="20"
                            ...
                            <el-col :span="6">
                                <el-button type="primary"
                                    ...
                                    size="mini"
                                    plain
                                    @click="addSearch()">+增加</el-button>
                                <small>最多10条</small>
                            </el-col>
                            <div class="mt20">&nbsp;</div>
                            <div class="clearfix"
                                v-for="(item, index) in form.search"
                                :key="index">
                                <el-col :span="12">
                    ...
                    <el-col :span="8">
                        <el-form-item label="快递"
                            prop="express_type">
                            <el-select v-model="form.express_type"
                                placeholder="请选择">
                                <el-option v-for="(item,index) in getExpressTypes"
                                    :key="index"
                                    :label="item.name"
                                    :value="item.type"></el-option>
                            </el-select>
                            <small class="red">非商家快递费用 ({{getCostPrice.other_express}} 元 /单)</small>
                        </el-form-item>
                    </el-col>
                    <el-col :span="8">
                        <el-form-item label="任务加赏(元)"
                            prop="reward_money">
                            <el-input type="number"
                                v-model="form.reward_money"
                                placeholder="任务加赏"></el-input>
                    ...
                    <el-col class="clear"
                        ...
                        <el-form-item label="开始时间"
                            ...
                            <el-date-picker v-model="form.release_start_time"
                                type="datetime"
                                placeholder="选择日期时间"
                    ...
                    <el-col :span="8"
                        ...
                        <el-form-item label="结束时间"
                            prop="release_end_time">
                            <el-date-picker v-model="form.release_end_time"
                                type="datetime"
                                placeholder="选择日期时间"
                                default-time="12:00:00"
                                value-format="yyyy-MM-dd HH:mm:ss"></el-date-picker>
                    ...
                    <el-col :span="8"
                        v-if="form.release_type == '2'">
                        <el-form-item label="是否到点取消"
                            prop="is_time_out_cancel">
                    ...
                    <el-col class="clear"
                        :span="8">
                        <el-form-item label="延迟收货天数 "
                            prop="delay_accept">
                            <el-select v-model="form.delay_accept"
                                placeholder="请选择">
                                <el-option v-for="(item,index) in lateDay"
                                    :key="index"
                                    :label="item"
                    ...
                    <el-col class="clear"
                        ...
                        <el-form-item label="任务类型"
                            ...
                            <el-radio-group v-model="form.type">
                                <el-radio label="1">下单任务</el-radio>
                                <el-radio label="2">预售任务</el-radio>
                            </el-radio-group>
                        </el-form-item>
                    </el-col>
                    <el-col :span="16"
                        v-if="form.type == '2'">
                        <el-form-item label="指定买手下单时间"
                            prop="limit_buy_time">
                            <el-radio-group v-model="form.limit_buy_time">
                                <el-radio label="1">
                                    隔一天
                                    <small class="red">({{getCostPrice.cur_limit_buy_time_1}} 元 /单)</small>
                                </el-radio>
                                <el-radio label="2">
                                    隔二天
                                    <small class="red">({{getCostPrice.cur_limit_buy_time_2}} 元 /单)</small>
                                </el-radio>
                                <el-radio label="3">
                                    隔三天
                                    <small class="red">({{getCostPrice.cur_limit_buy_time_3}} 元 /单)</small>
                                </el-radio>
                                <el-radio label="4">
                                    隔四天
                                    <small class="red">({{getCostPrice.cur_limit_buy_time_4}} 元 /单)</small>
                                </el-radio>
                            </el-radio-group>
                        </el-form-item>
                    </el-col>
                    ...
                    <el-col class="clear"
                        ...
                        <el-form-item label="特殊需求"
                            ...
                            <el-input type="textarea"
                                ...
                                placeholder="重要！如果对用户有特别的要求，请在特殊需求里注明，用户在做任务时会看到，最多不能超过300字(特殊需求只是商家要求，我们只能做到传达给用户但不会强制用户按要求执行)"></el-input>
                        </el-form-item>
                    </el-col>
                    <el-col :span="24">
                    ...
                    <el-col class="clear"
                        ...
                        <el-form-item label-width="300"
                            label="是否限制做过此商品浏览任务的账号可接此任务">
                            <el-radio-group v-model="form.is_only_allow_browse">
                                <el-radio label="0">不限</el-radio>
                                <el-radio label="1">仅限</el-radio>
                            </el-radio-group>
                            <small class="red">({{getCostPrice.only_allow_browse}} 元 /单)</small>
                            <small>(标签单)</small>
                        </el-form-item>
                    </el-col>
                    <el-col :span="16">
                    ...
                    <el-col :span="8">
                        <el-form-item label="信用等级"
                            prop="credit_level">
                            <el-select v-model="form.credit_level"
                                placeholder="请选择">
                                <el-option v-for="(item,index) in getCreditLevels"
                                    :key="index"
                                    :label="item.name"
                                    :value="item.type"></el-option>
                            </el-select>
                    ...
                    <el-col :span="8">
                        <el-form-item label="花呗号下单"
                            prop="huabei">
                            <el-radio-group v-model="form.huabei">
                                <el-radio label="0">不需要</el-radio>
                                <el-radio label="1">需要</el-radio>
                            </el-radio-group>
                            <small class="red ml20">({{getCostPrice.huabei}} 元 /单)</small>
                        </el-form-item>
                    </el-col>

                    <el-col :span="12">
                        <el-form-item label="高优质买号"
                            prop="grade_buyer">
            ...
            <div class="button">
                <el-button type="warning"
                    v-if="!status"
                    @click="submit('form')">提交核对价钱</el-button>
            </div>
        </div>
        <el-dialog title="确认任务"
            :visible.sync="status"
            center
            :lock-scroll="false">
            <div class="tableBox">
            ...
            <div slot="footer"
                class="dialog-footer">
                <el-button type="warning"
                    @click="submit2('form')">确认提交任务</el-button>
