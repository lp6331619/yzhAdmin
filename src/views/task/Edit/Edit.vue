        ...
        <div class="p20">
            <el-form ref="form" class="form" :rules="rulesBox" :model="form" label-width="140px">
                <el-row :gutter="20">
                    ...
                    <el-col class="clear" :span="8">
                        <el-form-item label="延迟收货天数 " prop="delay_accept">
                            <el-select v-model="form.delay_accept" placeholder="请选择">
                                <el-option
                                    v-for="(item,index) in lateDay"
                                    :key="index"
                                    :label="item"
                                    :value="index"
                                ></el-option>
                    ...
                    <el-col class="clear" :span="24">
                        <el-form-item label-width="300" label="是否限制做过此商品浏览任务的账号可接此任务">
