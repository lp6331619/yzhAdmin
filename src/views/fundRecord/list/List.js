export default {
    ...
    methods: {
        ...
        onExport() {//导出表格
            ...
            window.open(`http://yzh.jiqimao.uiping.com/AccountLog/getLogList?token=${token}&type=${this.selectData.type}&export=1&start_time=${this.selectData.start_time}&end_time=${this.selectData.end_time}`);
        }
    },
}