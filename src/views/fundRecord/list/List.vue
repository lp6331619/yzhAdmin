  ...
  <div class="list">
    ...
    <div class="p20">
      ...
      >
        ...
        <el-table-column prop="frozen_money" label="冻结金额" align="center" width="auto"></el-table-column>
        <el-table-column prop="balance_capital_money" label="本金可用余额" align="center" width="auto"></el-table-column>
