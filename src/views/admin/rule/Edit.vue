...
<div class="edit">
	<el-row :gutter="20">
		<h1 class="backTitle"><router-link to="/admin/rule/modifies"><i class="iconfont icon-left"></i>改签列表</router-link></h1>
		<el-form
        ...
        :model='tableData'>
			<el-col :span="14">
				<el-form-item label="改签规则" prop="name">
					<el-input v-model="tableData.name" placeholder="请输入改签规则"></el-input>
				</el-form-item>
			</el-col>
      ...
      <el-col :span="24">
        <el-form-item label="改签说明" >
          <vue-editor id="detail" v-model="tableData.remark" placeholder="请输入改签说明"></vue-editor>
        </el-form-item>
      </el-col>
      <el-col class="clear" >
				<el-form-item>
          ...
          if(this.tableData.change_type!=1 && this.tableData.change_type!=2){
            ...
            axios(options).then((res) => {
              if(res.data.error_code==0){
                ...
                this.$router.push('/admin/rule/modifies')
              }else{
                this.loading=false;
