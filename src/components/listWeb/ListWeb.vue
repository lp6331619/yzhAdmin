<template>
  <div class="list">
    ...
    <el-table :data="tableData.stations" border style="width: 100%" align="center">
      <el-table-column prop="name_cn" label="站点名称" align="center" width="auto"></el-table-column>
      <el-table-column prop="name_en" label="站点代码" align="center" width="auto"></el-table-column>
      <el-table-column prop="country_name" label="国家" align="center" width="130" :sortable="true"></el-table-column>
      <el-table-column prop="country_code" label="国家代码" align="center" width="130" :sortable="true"></el-table-column>
      <el-table-column prop="city_name_cn" label="城市" align="center" width="130" :sortable="true"></el-table-column>
      <el-table-column prop="city_name_en" label="城市代码" align="center" width="130" :sortable="true"></el-table-column>
      <el-table-column
        prop="status"
        label="状态"
        align="center"
    ...
    <el-dialog size="mini" title="编辑/新增站点" width="500px" :visible.sync="dialogFormVisible">
      <el-form label-width="100px" :rules="formRules" ref="formData" :model="formData">
      ...
      <div slot="footer" class="dialog-footer">
        ...
        <el-button type="warning" @click="submit('formData')">确 定</el-button>
      </div>
    </el-dialog>
  </div>
</template>
