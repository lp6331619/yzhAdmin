  ...
  <div class="list">
    <el-form :inline="true" :model="selectData" class="demo-form-inline">
      ...
      <el-form-item class="fr">
        <el-button type="warning" @click="addList()">+ 新增</el-button>
      </el-form-item>
    </el-form>
    <el-table
      v-loading="loading"
      ...
      align="center"
    >
      <el-table-column prop="img" label="图片" align="center" width="70">
      ...
      <el-table-column prop="name" label="产品名称" align="center" width="auto">
        <template slot-scope="scope">
          <a href="javascript:;" class="blue" @click="Preview(scope.row)">{{scope.row.name}}</a>
        </template>
      </el-table-column>
      <el-table-column prop="price" label="价格(元)" align="center" width="130" :sortable="true"></el-table-column>
      <el-table-column prop="type_name" label="类别" align="center" width="130" :sortable="true"></el-table-column>
      <el-table-column prop="country_name" label="所属国家" align="center" width="140" :sortable="true"></el-table-column>
      <el-table-column prop="is_online" label="状态" align="center" :sortable="true" width="130">
        <template slot-scope="scope">{{scope.row.is_online==0? '下架' : '上架'}}</template>
      </el-table-column>
