<template>
  <div class="list">
    ...
    <el-table :data="tableData.goods" border style="width: 100%" align="center">
      <el-table-column prop="departure" label="出发站" align="center" width="auto"></el-table-column>
      <el-table-column prop="arrival" label="到达站" align="center" width="auto"></el-table-column>
      <el-table-column prop="name" label="产品来源" align="center" width="130" :sortable="true"></el-table-column>
      <el-table-column prop="price" label="价格" align="center" width="130" :sortable="true">
        <template slot-scope="scope">{{scope.row.price}}{{scope.row.countrys_name}}</template>
      </el-table-column>
      <el-table-column
        prop="is_online"
        label="状态"
      ...
      <el-table-column label="操作" width="190" align="center">
        <template slot-scope="scope">
          <el-button-group>
            <el-button size="mini" type="warning" plain @click="handleEdit(scope.row.id)">编辑</el-button>
            <el-button
              size="mini"
              @click="handleBeing(scope.row)"
            >{{scope.row.is_online==1?'下架':'上架'}}</el-button>
            <el-button size="mini" type="danger" plain @click="handleDel(scope.row,scope.$index)">删除</el-button>
          </el-button-group>
        </template>
      </el-table-column>
    </el-table>
